...
export default function* root() {
  yield all([
    ...
    takeLatest(
      JobOpportunityTypes.JOB_OPPORTUNITIES_REQUEST,
      getJobOpportunities,
      Api,
    ),
    takeLatest(
      JobOpportunityTypes.JOB_OPPORTUNITY_REQUEST,
      getJobOpportunity,
      Api,
    ),
    ...
    takeLatest(
      JobApplicationTypes.JOB_APPLICATION_REQUEST,
      jobApplication,
      Api,
    ),
    takeLatest(
      JobApplicationTypes.GET_JOB_APPLICATIONS_REQUEST,
      getJobApplications,
      Api,
    ),
    takeLatest(
      JobApplicationTypes.JOB_APPLICATION_SAVE_DOCUMENT_REQUEST,
      saveDocument,
      Api,
    ),
    takeLatest(
      JobApplicationTypes.JOB_APPLICATION_GET_DOCUMENTS_REQUEST,
      getDocuments,
      Api,
    ),
    takeLatest(
      JobApplicationTypes.JOB_APPLICATION_CANCEL_APPLICATION_REQUEST,
      cancelApplication,
      Api,
    ),
